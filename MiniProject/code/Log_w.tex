...
\begin{document}
	...
	\section*{Methods}
	Microbial \pps\ data were given from ten different publications (Table\ref{table:source}).  The collection contained different microbial clades growing at various conditions for varying times.  Also, these data were recorded using multiple time units and population units.  Some of the population data were direct counts while some were not.  
