...
\newcommand{\Pml}{Phenological model}
\newcommand{\Pms}{Phenological models}
\newcommand{\ReportTitle}{Modeling microbial growth -- which is better and why?} %% <https://stackoverflow.com/questions/1211888/is-there-any-way-i-can-define-a-variable-in-latex>
...
\begin{document}
 ...
 %% insert_num_here
  t.lag.\\
 	...
 	From Fig.\ref{biptPCA}, \fve\ was having no observable patterns.  Since \fgo\ was not a ``best-fit" candidate from any dataset, it could not be shown on the PCA analysis.  \fba\ was generally observed being positively-correlated with r.max but negatively relating to N0, K and t.lag.  \fbu\ was observed being positively correlated with all four parameters.
