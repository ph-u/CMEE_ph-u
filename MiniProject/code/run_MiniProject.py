...
subprocess.Popen("Rscript Log_2.R 12> nohup.out", shell=True).wait() ## statistical analysis -- is one or more model(s) stand out from the rest?
subprocess.Popen("Rscript Log_3.R 12> nohup.out", shell=True).wait() ## statistical analysis -- do any parameters favours any phenological model(s)?
