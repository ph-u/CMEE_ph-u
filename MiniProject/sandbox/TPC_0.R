...
a.0<-data.frame(a.0$ID, a.0$Replicates, a.0$Citation, a.0$OrignalTraitName, a.0$OriginalTraitValue, a.0$OriginalTraitUnit, a.0$ConTemp, stringsAsFactors = F)
...
write.table(a.1, "../data/TPC_Uq.txt",sep="\t", quote=F)
